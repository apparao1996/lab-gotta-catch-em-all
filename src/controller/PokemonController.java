...
public class PokemonController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (value3 != null) {
			...
			request.setAttribute("message2",d.getPokemonNumber());
			request.setAttribute("character2", d.getCharacteristics());
			request.setAttribute("type2",d.getType());
		...
		if (value4 != null) {
			...
			request.setAttribute("message2",m.getPokemonNumber());
			request.setAttribute("character2",m.getCharacteristics());
			request.setAttribute("type2",m.getType());
			request.setAttribute("evolution2", m.getEvolution());
			request.setAttribute("baseExp2", m.getBaseExp());
		}
		...
		if (value5 != null) {
			...
			request.setAttribute("message2",p.getPokemonNumber());
			request.setAttribute("character2",p.getCharacteristics());
			request.setAttribute("type2",p.getType());
			request.setAttribute("evolution2",p.getEvolution());
			request.setAttribute("baseExp2", p.getBaseExp());
